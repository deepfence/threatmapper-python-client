...
class ModelScanStatusResp(
        ...
        class properties:
            ...
            class statuses(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def additional_properties() -> typing.Type['ModelScanInfo']:
                        return ModelScanInfo
            
                
                def __getitem__(self, name: typing.Union[str, ]) -> 'ModelScanInfo':
                    # dict_instance[name] accessor
                    return super().__getitem__(name)
                
                def get_item_oapg(self, name: typing.Union[str, ]) -> 'ModelScanInfo':
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, ],
        statuses: typing.Union[MetaOapg.properties.statuses, dict, frozendict.frozendict, None, ],
        _configuration: typing.Optional[schemas.Configuration] = None,
