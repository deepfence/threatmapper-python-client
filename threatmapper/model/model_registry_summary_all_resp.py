...
class ModelRegistrySummaryAllResp(
    ...
    class MetaOapg:
        ...
        @staticmethod
        def additional_properties() -> typing.Type['ModelSummary']:
            return ModelSummary

    
    def __getitem__(self, name: typing.Union[str, ]) -> 'ModelSummary':
        # dict_instance[name] accessor
        return super().__getitem__(name)
    
    def get_item_oapg(self, name: typing.Union[str, ]) -> 'ModelSummary':
