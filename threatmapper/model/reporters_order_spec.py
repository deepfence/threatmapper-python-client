...
class ReportersOrderSpec(
    ...
    descending: MetaOapg.properties.descending
    field_name: MetaOapg.properties.field_name
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["descending"]) -> MetaOapg.properties.descending: ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["descending", "field_name", "size", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["descending"]) -> MetaOapg.properties.descending: ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["descending", "field_name", "size", ], str]):
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, ],
        descending: typing.Union[MetaOapg.properties.descending, bool, ],
