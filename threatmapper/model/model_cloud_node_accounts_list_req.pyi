...
class ModelCloudNodeAccountsListReq(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["window", "cloud_provider", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["window", "cloud_provider", ], str]):
