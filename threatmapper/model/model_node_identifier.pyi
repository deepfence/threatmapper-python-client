...
class ModelNodeIdentifier(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["node_id", "node_type", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["node_id", "node_type", ], str]):
