...
class ModelFetchWindow(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["offset", "size", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["offset", "size", ], str]):
