...
if TYPE_CHECKING:
    from ..models.model_scan_info_severity_counts import ModelScanInfoSeverityCounts
...
class ModelScanInfo:
    ...
    Example:
        {'severity_counts': {'key': 6}, 'status_message': 'status_message', 'node_type': 'node_type', 'updated_at': 1,
            'node_name': 'node_name', 'created_at': 0, 'scan_id': 'scan_id', 'node_id': 'node_id', 'status': 'status'}
    ...
    Attributes:
        ...
        status_message (str):
        updated_at (int):
        severity_counts (Optional[ModelScanInfoSeverityCounts]):
    """
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if _severity_counts is None:
            ...
            severity_counts = ModelScanInfoSeverityCounts.from_dict(_severity_counts)
