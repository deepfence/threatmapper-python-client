...
T = TypeVar("T", bound="ModelRegistrySummaryAllResp")


@_attrs_define
class ModelRegistrySummaryAllResp:
    """ """
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        d = src_dict.copy()
        model_registry_summary_all_resp = cls()
        ...
        model_registry_summary_all_resp.additional_properties = additional_properties
        return model_registry_summary_all_resp
