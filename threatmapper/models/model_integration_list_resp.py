...
class ModelIntegrationListResp:
    ...
    Example:
        {'notification_type': 'notification_type', 'filters': {'fields_filters': {'compare_filter': [{'greater_than':
            ...
            {'key': ['', '']}}}, 'container_names': ['container_names', 'container_names'], 'node_ids': [{'node_type':
            'image', 'node_id': 'node_id'}, {'node_type': 'image', 'node_id': 'node_id'}]}, 'id': 0, 'integration_type':
            'integration_type', 'config': {'key': ''}, 'last_error_msg': 'last_error_msg'}
