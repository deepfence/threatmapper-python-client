...
T = TypeVar("T", bound="ModelScanStatusRespStatuses")


@_attrs_define
class ModelScanStatusRespStatuses:
    """ """
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        d = src_dict.copy()
        model_scan_status_resp_statuses = cls()
        ...
        model_scan_status_resp_statuses.additional_properties = additional_properties
        return model_scan_status_resp_statuses
