...
class ModelCloudNodeAccountRegisterRespData:
    ...
    Example:
        {'cloudtrail_trails': [{'account_id': 'account_id', 'trail_name': 'trail_name'}, {'account_id': 'account_id',
            'trail_name': 'trail_name'}], 'scans': {'key': {'account_id': 'account_id', 'benchmarks': [{'controls':
            ['controls', 'controls'], 'compliance_type': 'compliance_type', 'id': 'id'}, {'controls': ['controls',
            'controls'], 'compliance_type': 'compliance_type', 'id': 'id'}], 'scan_id': 'scan_id', 'scan_types':
            ['scan_types', 'scan_types']}}, 'refresh': 'refresh'}
