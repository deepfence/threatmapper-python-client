...
def _get_kwargs(
    *,
    json_body: ModelIntegrationAddReq,
) -> Dict[str, Any]:
    pass
...
def sync_detailed(
    *,
    ...
    Args:
        json_body (ModelIntegrationAddReq):  Example: {'notification_type': 'notification_type',
            'filters': {'fields_filters': {'compare_filter': [{'greater_than': True, 'field_value':
