...
# body param
SchemaForRequestBodyMultipartFormData = FormDataModelRegistryGCRAddReq
...
class AddRegistryGcr(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def add_registry_gcr(
        self,
        content_type: typing_extensions.Literal["multipart/form-data"] = ...,
        body: typing.Union[SchemaForRequestBodyMultipartFormData, schemas.Unset] = schemas.unset,
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
    ...
    def add_registry_gcr(
        ...
        return self._add_registry_gcr_oapg(
            body=body,
