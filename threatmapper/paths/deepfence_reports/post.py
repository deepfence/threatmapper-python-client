...
# body param
SchemaForRequestBodyApplicationJson = ModelGenerateReportReq


request_body_model_generate_report_req = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = ModelGenerateReportResp
...
class BaseApi(api_client.Api):
    ...
    def _generate_report_oapg(
        ...
        if body is not schemas.unset:
            serialized_data = request_body_model_generate_report_req.serialize(body, content_type)
